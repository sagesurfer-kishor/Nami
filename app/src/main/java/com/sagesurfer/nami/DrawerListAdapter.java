...
import com.sagesurfer.nami.icons.GetDrawerIcon;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (headerList.size() > 2) {
            ...
            if (headerList.get(groupPosition).isSelected()) {
                headerViewHolder.indicator.setImageResource(R.drawable.down_arrow_green);
            } else {
                headerViewHolder.indicator.setImageResource(R.drawable.right_arrow_gray);
            }
        }
        return view;
    }
